...
from Helper_Functions_MRI_withSRmodule import Tensorboard_Initialization, Logbook_Initialization
from Helper_Functions_MRI_withSRmodule import Intermediate_Visualization
from DatasetClasses_MicroMRI_withSRmodule import Get_DataLoaders
from UNet_Model_MRI_withSRmodule import UNet_withSR, count_model_parameters
...
DL_Model = UNet_withSR(
        ...
        num_channels_SRmodule = num_channels_SRmodule)
...
ModelUNet_Params = [dim, num_in_channels, features_main, features_skip, conv_kernel_size, down_mode, up_mode, activation, residual_connection, num_channels_SRmodule] 
