...
When comparing with the results of the base U-Net, the darkening of certain regions of the images is less of a problem in the case of the APDDM results, which might be attributed to the use of a different normalization technique. 
Parts of the anatomy show signs of excessive smoothing, similar as in the case of the base U-Net, as discussed above, which results in some anatomical structures not being visible, while being visible on the HR images. \\
