...
On the other hand, increasing acquisition time can enhance signal quality and SNR \cite{grover2015mri}. However, this increases the risk of artefacts, blurring, and motion-related distortions.
...
The training was done on the accelgor clustern because of its GPU capability. 
...
Some examples of test mice slices from the simplified APDDM model, compared to the same slices from the base UNet model can be seen in %AANPASSEN. %
More examples of each combination of region
and anatomical Plane can be found in Appendix D.3. %AANPASSEN%
...
\begin{thebibliography}{99}
    ...
    %vanaf hieronder niet geciteerd in tekst?
    ...
    \bibitem{unknown-author-no-date} Unknown Author. (n.d.). Tutorials. Retrieved from \url{https://www.overleaf.com/learn/latex/Tutorials}.  %check of deze wel klopt
