...
Parts of the anatomy show signs of excessive smoothing, similar as in the case of the base UNet, as discussed above, which results in some anatomical structures not being visible, while being visible on the HR images. \\
...
Validation through both quantitative metrics and visual inspection confirmed that the model enhances low-resolution scans, potentially enabling 1-min scans in preclinical MRI settings, but further model optimization and more training data is required to result in more consistent and robust outcomes.
...
In summary, this project forms a foundation for integrating deep learning into preclinical imaging workflows, aiding in faster acquisition times without sacrificing diagnostic value. 
